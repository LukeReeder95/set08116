...
bool update(float delta_time) {
  ...
  {
	  meshes["chaser"].get_transform().rotate(vec3(0.0f, half_pi<float>()*delta_time, 0.0f));
  }
  ...
  {
	  meshes["chaser"].get_transform().position += vec3(1.0f * delta_time, 0.0f, 0.0f);
  }
  ...
  {
	  meshes["chaser"].get_transform().position += vec3(0.0f, 0.0f, 1.0f * delta_time);
  }
